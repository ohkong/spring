...
<tr><td>레시피명</td><td colspan="2"><input type="text" name="name" id="name"></td></tr>
<tr><th>재료입력</th><td colspan="2"><input type="text" id="raw" width="95%"></td></tr>
<tr>
<td rowspan="4">		
	<div class="inputArea">
...
<tr><th>레시피방식</th><td>
	...
	<li class="item"><input type="radio" id="recway" value="끓이기"  ></li>
	<li class="item">끓이기</li>
	<li class="item"><input type="radio" id="recway" value="찌기"   ></li>
	<li class="item">찌기</li>
	<li class="item"><input type="radio" id="recway" value="기타"  ></li>
	<li class="item">기타</li>
	<li class="item"><input type="radio" id="recway" value="굽기"  ></li>
	<li class="item">굽기</li>
	<li class="item"><input type="radio" id="recway" value="튀기기"></li>
	<li class="item">튀기기</li>
	<li class="item"><input type="radio" id="recway" value="볶기"  ></li>
	<li class="item">볶기</li>
</ul>
</td>
</tr>
<tr><th>조리패턴</th><td> 
	<ul class="resultSet" style="width: 100%">
	<li class="item"><input type="radio" id="recpat" value="밥"  ></li>
	<li class="item">밥</li>
	<li class="item"><input type="radio" id="recpat" value="반찬"  ></li>
	<li class="item">반찬</li>
	<li class="item">	<input type="radio" id="recpat" value="국&찌개"  ></li>
	<li class="item">국&찌개</li>
	<li class="item"><input type="radio" id="recpat" value="일품" <c:if test= "${pat.contains('일품')}"> checked="checked" </c:if> ></li>
	<li class="item">일품</li>
	<li class="item"><input type="radio" id="recpat" value="기타" ></li>
	<li class="item">기타</li>
	<li class="item"><input type="radio" id="recpat" value="후식" ></li>
	<li class="item">후식</li>
	</ul></td></tr>
...
<input type="hidden" id="chrecipePic" value="0">
	 <script>
      ...
      $(document).ready(function() {
          ...
          $('.submit a').on('click',function() {                        
              ...
              for (var index = 0; index < Object.keys(files).length; index++) {
                  ...
                  formData.append('foodPicFile',$("input#foodPic")[0].files[0]);
      ...
      function inputCheck(){
    	  console.log($("input#foodPic")[0].files[0])
//           if($("input#recpat").val()==""){
