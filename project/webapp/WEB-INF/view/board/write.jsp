...
<form:form modelAttribute="board" action="write.shop"
   ...
   <table><tr><td>글쓴이</td><td><form:input path="name" value="${member.name}"/>
     <font color="red"><form:errors path="name" /></font></td></tr>
   <tr><td>비밀번호</td><td><form:password path="pass" value="${member.pass}"/>
...
<%--    <tr><td>판매</td><td><form:input path="sell" /> --%>
<%--    <font color="red"><form:errors path="sell" /></font></td></tr> --%>
<%--    <tr><td>구매</td><td><form:input path="buy" /> --%>
<%--    <font color="red"><form:errors path="buy" /></font></td></tr> --%>
<tr><th>구매 or 판매</th><td>
   ...
   <tr><td colspan="2"><a href="javascript:document.boardform.submit()">[게시글 등록]</a>
    <a href="list.shop">[게시글 목록]</a></td></tr></table></form:form>
