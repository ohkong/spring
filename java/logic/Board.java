...
public class Board {
	...
	private int grpstep;
	@NotEmpty(message="도로명 주소로 입력하세요.")
	...
	public String toString() {
		return "Board [num=" + num + ", name=" + name + ", pass=" + pass + ", subject=" + subject + ", buy=" + buy
				+ ", price=" + price + ", content=" + content + ", file1=" + file1 + ", fileurl=" + fileurl
				+ ", regdate=" + regdate + ", readcnt=" + readcnt + ", grp=" + grp + ", grplevel=" + grplevel
				+ ", grpstep=" + grpstep + ", location=" + location + "]";
	}
